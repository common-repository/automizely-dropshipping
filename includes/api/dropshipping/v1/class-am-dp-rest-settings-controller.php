...
if (! class_exists('AM_DP_REST_Settings_Controller') ) {

    include AUTOMIZELY_DROPSHIPPING_PATH . '/includes/class-am-rest-controller.php';

    /**
     * Class AM_DP_REST_Settings_Controller
     */
    class AM_DP_REST_Settings_Controller extends AM_REST_Controller
    {


        /**
         * API endpoint always wc/dropshipping/v1.
         *
         * @var string
         */
        protected $namespace = 'wc/dropshipping/v1';
        /**
        ...
        /**
         * Dropshipping option name.
         *
         * @var string
         */
        private $option_name = 'dropshipping_option_name';
        ...
        public function get_settings()
        {
            ...
            $settings['version'] = array(
                ...
                'dropshipping'   => AUTOMIZELY_DROPSHIPPING_VERSION,
            );
